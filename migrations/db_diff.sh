...
## RESET THE TEMPDB
psql -h localhost -p 5400 -U app -c "DROP DATABASE IF EXISTS $TEMPDB"
psql -h localhost -p 5400 -U app -c "CREATE DATABASE $TEMPDB"

## RUN EXISTING MIGRATIONS ON TEMP DB
goose postgres "postgres://app@localhost:5400/${TEMPDB}?sslmode=disable" up
